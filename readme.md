🛠️ How to use:
   ...
   2.Install Zenity
    ...
    4.Open stardew_Cross-Platform.sh with text editor
...
/home/yourname/.local/share/applications/
    ...
    6.open StardewSync.desktop with text editor

Change this line to your stardew_Cross-Platform.sh location:
Exec=bash "/home/yourname/Documents/VsCode/Stardew Valley Cross-Platform Save Manager/stardew_Cross-Platform.sh"
    ...
    play backup/restore your save file clossplatform for linux and android :)